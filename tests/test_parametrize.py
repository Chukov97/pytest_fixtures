...
@pytest.mark.parametrize('browser_management', [(config.window_height_desktop_1, config.window_width_desktop_1),
                                                (config.window_height_desktop_2, config.window_width_desktop_2)],
                         indirect=True)
...
@pytest.mark.parametrize('browser_management', [(config.window_height_mobile_1, config.window_width_mobile_1),
                                                (config.window_height_mobile_2, config.window_width_mobile_2)],
                         indirect=True)
